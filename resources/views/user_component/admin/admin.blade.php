                      ...
                      <div class="card">
                        ...
                        <div class="content">
                          ...
                          <span style="float:right"> <?php if($datas->status_tampil == "tampil"){?>
                            <a href="{{url('/berita/shownhide',$datas->id)}}" role="button" class="btn btn-fill btn-primary"><i class="fa fa-check"></i> Sembunyikan</a>
                            <?php } else {
                              ?>
                              <a href="{{url('/berita/shownhide',$datas->id)}}" role="button" class="btn btn-fill btn-primary"><i class="fa fa-close"></i> Tampilkan</a>
                              <?php
                            }
                            ?></span>
                        </p>
